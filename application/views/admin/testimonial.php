                ...
                <!-- /.row -->
                  ...
                  <div class="row">
                    <div class="col-lg-8">
                        ...
                        <form role="form" class="form-horizontal" action="<?php echo $base_url."admin/insert_testimonial" ?>" method="post">

                            <div class="form-group">
                                <label class="col-sm-2">Testimonial</label>
                                <div class="col-sm-10">
                                <textarea class="form-control" required name="testimonial" placeholder="Testimonial" rows="3"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2">Testimonial Inggris</label>
                                <div class="col-sm-10">
                                <textarea class="form-control" required name="testimonial2" placeholder="Testimonial" rows="3"></textarea>
                                </div>
                            </div>
							<div class="form-group">
                                <label class="col-sm-2">From</label>
								<div class="col-sm-10">
                                <input class="form-control" name="from" placeholder="From" required>
								</div>
                            </div>
