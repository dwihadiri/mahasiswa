...
<head>
	...
	<script type="text/javascript">
	  function confirmDelete(id){
		...
		if(conf) 
		window.location='<?php echo $base_url."admin/delete_news/"?>'+id;
	}
	 function set_featured(id){
		 var conf = confirm('Are you sure you want to set featured!');
		if(conf) 
		window.location='<?php echo $base_url."admin/set_featured/"?>'+id;
	}
	function remove_featured(id){
		 var conf = confirm('Are you sure you want to remove featured!');
		if(conf) 
		window.location='<?php echo $base_url."admin/remove_featured/"?>'+id;
	}
	</script>
</head>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<div class="row">
                    <div class="col-lg-12">
						<a href="<?php echo $base_url;?>admin/add_news" style="float:right">
					...
					<?php foreach ($data_news as $a) {?> 
						<tr role="row" class="odd">
							...
							<td align="center" colspan="2">
								<a href="<?php echo $base_url;?>admin/edit_news/<?php echo $a->news_id;?>">
