...
<head>
	...
	<script type="text/javascript">
	  function confirmDelete(id){
		...
		if(conf) 
		window.location='<?php echo $base_url."admin/delete_awards/"?>'+id;
	}
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<div class="row">
                    <div class="col-lg-12">
						<a href="<?php echo $base_url;?>admin/add_awards" style="float:right">
                ...
                <div class="row">
					...
					<thead>
						<tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Subscriber id: activate to sort column descending" style="width: 138px;">Awards id</th>
					...
					<tbody>
					<?php foreach ($data_awards as $a) {?> 
						<tr role="row" class="odd">
							<td class="sorting_1"><?php echo $a->awards_id;?></td>
							...
							<td align="center" colspan="2">
								<a href="<?php echo $base_url;?>admin/edit_awards/<?php echo $a->awards_id;?>">
								<button type="button" class="btn btn-default">Edit</button>
								</a>
								<button type="button" class="btn btn-default" onclick="return confirmDelete('<?php echo $a->awards_id?>')">Delete</button>
							</td>
						</tr>
					<?php }?>
					</tbody>
