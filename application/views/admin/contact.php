...
<head>
	...
	<script type="text/javascript">
	  function confirmDelete(id){
		...
		if(conf) 
		window.location='<?php echo $base_url."admin/delete_contact/"?>'+id;
	}
	</script>
</head>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
					...
					<thead>
						<tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Subscriber id: activate to sort column descending" style="width: 138px;">Contact id</th>
						<th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Name: activate to sort column ascending" style="width: 219px;">Name</th>
						...
						<th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Phone: activate to sort column ascending" style="width: 99px;">Phone</th>
						<th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Category: activate to sort column ascending" style="width: 43px;">Category</th>
                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Message: activate to sort column ascending" style="width: 43px;">Message</th>
						<th class="sorting" style="width: 43px;text-align:center">Action</th>
						</tr>
					</thead>
					
					<tbody>
					<?php foreach ($data_contact as $a) {?> 
						<tr role="row" class="odd">
							<td class="sorting_1"><?php echo $a->contact_id;?></td>
							...
							<td class="desc"><?php echo $a->message;?></td>
							<td colspan="2" align="center">
								<!--<button type="button" class="btn btn-default">Edit</button>-->
								<button type="button" class="btn btn-default" onclick="return confirmDelete('<?php echo $a->contact_id?>')">Delete</button>
							</td>
						</tr>
					<?php }?>
					</tbody>
   ...
   $("#exportExcel").click(function(){
      $('<table>')
         ...
         .table2excel({
            ...
            name: "Worksheet Name",
            filename: "Contact" //do not include extension
         });
   });
