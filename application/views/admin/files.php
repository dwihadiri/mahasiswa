...
<?php  if($status_error=='1'):?><div style="text-align: center; color: red; font-weight: bold; font-size: 12px;"><?php  echo $warning;?></div><?php  endif;?>
                        <form role="form" class="form-horizontal" action="<?php echo $base_url."admin/insert_files" ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="category">
                                        ...
                                        <option value="1">Investor Update</option>
                                        <option value="2">Financial Statement & Annual Report</option>
                                        <option value="3">Company Presentation</option>
                                    </select>
                                </div>
                            </div>
