...
<head>
	...
	<script type="text/javascript">
	  function confirmDelete(id){
		...
		if(conf) 
		window.location='<?php echo $base_url."admin/delete_files/"?>'+id;
	}
	</script>
</head>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<div class="row">
                    <div class="col-lg-12">
						<a href="<?php echo $base_url;?>admin/add_files" style="float:right">
					...
					<?php foreach ($data_files as $a) {?> 
						<tr role="row" class="odd">
							...
							<td align="center" colspan="2">
								<a href="<?php echo $base_url;?>admin/edit_files/<?php echo $a->file_id;?>">
